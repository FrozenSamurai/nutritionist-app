...
const EditMain = ({
  ...
  let [mealnum, setMealnum] = useState(Object.keys(currentData.Recall).length);
  ...
  let [age, setAge] = useState(currentData.Age);
  let [height, setHeight] = useState(currentData.Height);
  let [weight, setWeight] = useState(currentData.Weight);
  let [gender, setGender] = useState(currentData.Gender);
  ...
  console.log(currentData.Recall[Object.keys(currentData.Recall)[0]]);
          ...
          return (
            <>
              <EditMeal
                ...
                mealsobj={mealsobj}
                mealData={{
                  ...currentData.Recall[Object.keys(currentData.Recall)[i]],
                }}
                nutrients={nutrients}
                ...
                mealname={Object.keys(currentData.Recall)[i]}
