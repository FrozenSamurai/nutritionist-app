...
const Dashboard = ({
  ...
  return (
    <div className="before:w-full before:h-[100vh] before:min-h-fit before:blur-[2px] before:-z-[1000] h-screen min-h-fit  flex flex-col  before:bg-background before:brightness-[60%] before:absolute	 relative items-center  before:bg-cover">
